классический пример наследования можно показать на шахматах. Абстрактный класс фигуры содержит необходимый набор полей. Классы наследники дополняют или переопределяют методы
``` java
